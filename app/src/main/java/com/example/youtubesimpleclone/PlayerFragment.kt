package com.example.youtubesimpleclone
...
import com.example.youtubesimpleclone.adapter.VideoAdapter
import com.example.youtubesimpleclone.databinding.FragmentPlayerBinding
import com.example.youtubesimpleclone.dto.VideoDto
import com.example.youtubesimpleclone.service.VideoService
                ...
                .enqueue(object : Callback<VideoDto> {
                    override fun onResponse(call: Call<VideoDto>, response: Response<VideoDto>) {
                        if (response.isSuccessful.not()) {
                            Log.d("getVideoList", "Response Fail")
                            return
                        }
